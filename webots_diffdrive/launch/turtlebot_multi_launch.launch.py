...
def launch_setup(context, *args, **kwargs):
    ...
    urdf_template = os.path.join(package_dir, 'resource', 'turtlebot_multi.urdf')
    ros2ctrl_template = os.path.join(package_dir, 'resource', 'turtlebot_multi_ros2control.yml')
    nav2_template = os.path.join(package_dir, 'resource', 'turtlebot_multi_nav2_params.yaml')
...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument(
            'world',
            default_value='turtlebot_multi_world.wbt',
